...
local config = {
    ...
    java = {
      ...
      configuration = {
        runtimes = {
          {
            name = 'JavaSE-22',
            path = home .. '/.sdkman/candidates/java/22.0.1-amzn',
          },
          {
            name = 'JavaSE-21',
  ...
  cmd = {
    ...
    '-jar',
    vim.fn.glob '/opt/homebrew/Cellar/jdtls/1.36.0/libexec/plugins/org.eclipse.equinox.launcher_*.jar',

    -- The configuration for jdtls is also placed where jdtls was installed. This will
    -- need to be updated depending on your environment
    '-configuration',
    '/opt/homebrew/Cellar/jdtls/1.36.0/libexec/config_mac',
